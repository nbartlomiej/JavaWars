 ...
 * @author bartlomiej
 */
public abstract class PageWithHorizontalMenu extends Page {
     ...
     */
    public PageWithHorizontalMenu(String url) {
    ...
    protected final void updateStyle() {
        ...
        this.setStyleName("page page-horizontal page-level-" + level + " " + getUrl() + "-page");
        tabBar.setStyleName("menu menu-horizontal menu-level-" + level + " " + getUrl() + "-menu");
        contentWrapper.setStyleName("content content-horizontal content-level-" + level + " " + getUrl() + "-content");
